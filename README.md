...
The following plot shows the first few normalized eigenfunctions inside the potential well.
  
![Finite Difference Eigenfunctions](images/tise1.png)

The computed eigenenergies are plotted against the potential well.

![Energy Levels](images/tise2.png)
